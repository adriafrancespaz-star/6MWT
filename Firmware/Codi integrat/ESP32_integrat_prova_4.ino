...
// Variables para podómetro (Estrategia Cruzada)
unsigned long lastStepTime = 0;
const float STEP_THRESHOLD = 3.2;    // BAJADO: Para detectar ambas piernas (la fuerte y la suave)
const int STEP_TIMEOUT = 450;        // SUBIDO: Para ignorar los rebotes de la pierna fuerte
